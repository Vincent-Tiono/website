module.exports = {
  ...
  introduction: [
    ...
    'My current research focuses on **Programmatic Reinforcement Learning** and **Robot Learning**, aiming to enhance *interpretability* and *safety* in human-robot interaction. Generally speaking, I hold a strong interest in AI, Quant Trading, and Business.',
  ],
